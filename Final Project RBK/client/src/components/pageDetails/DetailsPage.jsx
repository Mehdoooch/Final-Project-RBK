    ...
    <div>
      <div className="container mx-auto px-6 py-10 mt-16 max-w-6xl bg-gray-50">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          <div className="lg:w-2/3">
            <div className="grid grid-cols-4 gap-4 mb-6">
              <img
                src={houseImages[0]?.url || dummyHouse}
                alt="House view 1"
                className="col-span-4 w-full h-96 object-cover rounded-lg shadow-lg hover:shadow-2xl transition duration-300"
              />
              <img
                src={houseImages[1]?.url || dummyHouse}
                alt="House view 2"
                className="col-span-2 w-full h-48 object-cover rounded-lg shadow-md hover:shadow-lg transition duration-300"
              />
              <img
                src={houseImages[2]?.url || dummyHouse}
                alt="House view 3"
                className="col-span-2 w-full h-48 object-cover rounded-lg shadow-md hover:shadow-lg transition duration-300"
              />
            </div>
            ...
            <div className="flex gap-4 mb-6">
              ...
              >
                ...
                {isReserved ? "View Reservation" : "Reserve Now"}
              </button>
        ...
        <div className="mt-12">
          ...
          <div className="bg-gray-200 h-96 rounded-lg shadow-md flex items-center justify-center hover:shadow-lg transition duration-300 relative z-10">
      ...
      {isReservationOpen && (
        <ReservationPopup
          ...
          onClose={handleReservationSuccess}
          house={house}
        />
      )}

      {isDetailsOpen && reservationDetails && (
